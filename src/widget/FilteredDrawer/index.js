                    ...
                    <div className="flex flex-col gap-3 mb-6">
                        ...
                        <div className="flex flex-col gap-2 ">
                            ...
                            <Controller
                                name="area"
                                control={control}
                                render={({ field }) => <Select {...field} value={field.value} placeholder="Select One" multipleValu={false} onChange={(val) => field.onChange(val)} options={areaData?.data} overlyClass="!bg-transparent" inputClass="py-2  px-4 w-full rounded bg-white ring-gary_700 text-black bg-gray_500 text-body2 focus:ring-1 focus:ring-gary_700 focus:outline-none ring-1" />}
                            />
                        </div>
                        <div className="flex flex-col gap-2">
