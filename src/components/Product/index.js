...
const Product = ({ item, index, onDelete }) => {
    ...
    const handleTouchEnd = () => {
        ...
        // Add a slight delay for smoother snapping back
    ...
    return (
        <>
            <div className="  w-full flex items-center justify-center">
                ...
                {/* <div
                    style={{
                        right: deleteButtonVisible
                            ? `${-swipePosition / 2 - 10}px`
                            : "-50px",
                        opacity: deleteButtonVisible ? 1 : 0,
                        visibility: deleteButtonVisible ? "visible" : "hidden",
                    }}
                    className={` absolute right-3 top-1/2 transform -translate-y-1/2 h-2 w-2 text-red-600 font-semibold transition-opacity duration-300`}
